            ...
            <div className="flex flex-col gap-1">
                {allImages.map((image, index) => (
                    <button
                        ...
                        className={`cursor-pointer flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-md overflow-hidden border-2 transition-all ${selectedImage === image
